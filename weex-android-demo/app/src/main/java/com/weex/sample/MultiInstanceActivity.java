...
public class MultiInstanceActivity extends AppCompatActivity {
    ...
    private static String LOCAL_JS_URL = "file://index.js";//hello.js

    private static String TEST_URL = "http://dotwe.org/raw/dist/6fe11640e8d25f2f98176e9643c08687.bundle.js";
    //private static String TEST_URL = "http://192.168.0.68:12580/examples/build/vue/hello.js";
    ...
    @OnClick({R.id.tv_info, R.id.containerA})
    ...
    private void renderPageA() {
        ...
        //mWXSDKInstanceA.fireGlobalEventCallback();
    }
